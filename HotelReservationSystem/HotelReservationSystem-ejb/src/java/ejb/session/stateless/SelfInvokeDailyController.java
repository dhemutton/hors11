 ...
 */
@Stateless
@Local(SelfInvokeDailyControllerLocal.class)
@Remote(SelfInvokeDailyControllerRemote.class)
public class SelfInvokeDailyController implements SelfInvokeDailyControllerRemote, SelfInvokeDailyControllerLocal {
    ...
    public void dailyReservationRoomAssignment() {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
        try {
                        day2 = formatter.parse("05/11/2018");
