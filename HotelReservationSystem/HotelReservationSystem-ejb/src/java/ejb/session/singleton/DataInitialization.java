...
//        partnerController.createNewPartner(new Partner("Jonathan", "password", true));
        ...
        roomTypeController.createRoomType(new RoomType("Family Room", "Standard room", 4, "1 super single bed", "4-6 people", "Toilet, balcony", 3, true, true));
        roomTypeController.createRoomType(new RoomType("Premier Room", "Decent room", 2, "1 single bed", "2-4 people", "Toilet", 4, true, true));
        roomTypeController.createRoomType(new RoomType("Deluxe Room", "Budget room", 1, "1 single bed", "2-4 people", "Toilet", 5, true, true));
...
//        roomRateController.createRoomRate(new RoomRate("Peak promo for Grand Suite", PEAK, new BigDecimal(160.50), date2, date3, true, roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Published promo for Grand Suite", PUBLISHED, new BigDecimal(150.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Normal promo for Grand Suite", NORMAL, new BigDecimal(140.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
//        roomRateController.createRoomRate(new RoomRate("Promo promo for Grand Suite", PROMO, new BigDecimal(130.50), date1, date2, true, roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());

//        roomRateController.createRoomRate(new RoomRate("Peak promo for Junior Suite", PEAK, new BigDecimal(120.50), date2, date3, true, roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Published promo for Junior Suite", PUBLISHED, new BigDecimal(110.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Normal promo for Junior Suite", NORMAL, new BigDecimal(100.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
//        roomRateController.createRoomRate(new RoomRate("Promo promo for Junior Suite", PROMO, new BigDecimal(90.50), date1, date2, true, roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());

//        roomRateController.createRoomRate(new RoomRate("Peak promo for Family Room", PEAK, new BigDecimal(80.50), date2, date3, true, roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Published promo for Family Room", PUBLISHED, new BigDecimal(70.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Normal promo for Family Room", NORMAL, new BigDecimal(60.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
//        roomRateController.createRoomRate(new RoomRate("Promo promo for Family Room", PROMO, new BigDecimal(50.50), date1, date2, true, roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());

//        roomRateController.createRoomRate(new RoomRate("Peak promo for Premier Room", PEAK, new BigDecimal(40.50), date2, date3, true, roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Published promo for Premier Room", PUBLISHED, new BigDecimal(30.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Normal promo for Premier Room", NORMAL, new BigDecimal(20.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
//        roomRateController.createRoomRate(new RoomRate("Promo promo for Premier Room", PROMO, new BigDecimal(10.50), date1, date2, true, roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());

//        roomRateController.createRoomRate(new RoomRate("Peak promo for Deluxe Room", PEAK, new BigDecimal(40.50), date2, date3, true, roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Published promo for Deluxe Room", PUBLISHED, new BigDecimal(10.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
        roomRateController.createRoomRate(new RoomRate("Normal promo for Deluxe Room", NORMAL, new BigDecimal(9.50), new Date(), new Date(), true, roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
//        roomRateController.createRoomRate(new RoomRate("Promo promo for Deluxe Room", PROMO, new BigDecimal(10.50), date1, date2, true, roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());

        roomController.createRoom(new Room("1001", roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomController.createRoom(new Room("1002", roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomController.createRoom(new Room("1003", roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomController.createRoom(new Room("1004", roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
        roomController.createRoom(new Room("1005", roomTypeController.retrieveRoomTypeByName("Grand Suite")), roomTypeController.retrieveRoomTypeByName("Grand Suite").getRoomTypeId());
       

        roomController.createRoom(new Room("2001", roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomController.createRoom(new Room("2002", roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomController.createRoom(new Room("2003", roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomController.createRoom(new Room("2004", roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        roomController.createRoom(new Room("2005", roomTypeController.retrieveRoomTypeByName("Junior Suite")), roomTypeController.retrieveRoomTypeByName("Junior Suite").getRoomTypeId());
        

        roomController.createRoom(new Room("3001", roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomController.createRoom(new Room("3002", roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomController.createRoom(new Room("3003", roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomController.createRoom(new Room("3004", roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        roomController.createRoom(new Room("3005", roomTypeController.retrieveRoomTypeByName("Family Room")), roomTypeController.retrieveRoomTypeByName("Family Room").getRoomTypeId());
        

        roomController.createRoom(new Room("4001", roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomController.createRoom(new Room("4002", roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomController.createRoom(new Room("4003", roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomController.createRoom(new Room("4004", roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        roomController.createRoom(new Room("4005", roomTypeController.retrieveRoomTypeByName("Premier Room")), roomTypeController.retrieveRoomTypeByName("Premier Room").getRoomTypeId());
        
        roomController.createRoom(new Room("5001", roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
        roomController.createRoom(new Room("5002", roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
        roomController.createRoom(new Room("5003", roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
        roomController.createRoom(new Room("5004", roomTypeController.retrieveRoomTypeByName("Deluxe Room")), roomTypeController.retrieveRoomTypeByName("Deluxe Room").getRoomTypeId());
...
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(2)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(2));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(3)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(3));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(4)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(4));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(5)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(5));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(6)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(6));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomTypeController.retrieveRoomTypeByName("Grand Suite"), roomController.retrieveRoomById(new Long(7)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(7));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Family Room"), roomTypeController.retrieveRoomTypeByName("Family Room"), roomController.retrieveRoomById(new Long(21)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(21));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Family Room"), roomTypeController.retrieveRoomTypeByName("Family Room"), roomController.retrieveRoomById(new Long(22)), booking, NONE));
...
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomController.retrieveRoomById(new Long(11)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(11));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomController.retrieveRoomById(new Long(12)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(12));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomController.retrieveRoomById(new Long(13)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(13));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomController.retrieveRoomById(new Long(14)), booking, NONE));
//        room = roomController.retrieveRoomById(new Long(14));
//        room.getReservations().add(reservation);
//        room.setIsVacant(Boolean.FALSE);
//        roomController.mergeRoom(room);
//        reservation = reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomTypeController.retrieveRoomTypeByName("Junior Suite"), roomController.retrieveRoomById(new Long(15)), booking, NONE));
...
//        reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Type D"), booking, UNASSIGNED));
    ...
    private void initializeDataDump() throws EmployeeExistException, GuestExistException, RoomTypeExistException, RoomRateExistException, RoomTypeNotFoundException, RoomExistException, PartnerExistException, GuestNotFoundException, ParseException, RoomTypeCannotHaveDuplicatePublishedOrNormalException {
        ...
        booking = bookingController.createNewBooking(new Booking(WALKIN, PENDING, formatter.parse("05/11/2018"), formatter.parse("10/11/2018")));
        reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Type C"), booking, UNASSIGNED));
        reservationController.createNewReservation(new Reservation(roomTypeController.retrieveRoomTypeByName("Type D"), booking, UNASSIGNED));
